...
namespace KAP_InventoryManager.Utils
{
    public class CustomerInvoiceSummaryReport
    {
        public void GenerateCustomerInvoiceSummaryReportPDF(IEnumerable<CustomerInvoiceSummaryModel> reports, string path, string month, string reportType, DateTime start, DateTime end)
        {
            ...
            var directoryPath = $@"{path}customer-invoice-summary\{month}\{reportType}";
            if (!Directory.Exists(directoryPath))
            {
                Directory.CreateDirectory(directoryPath);
            }

            var filePath = $@"{directoryPath}\{month}-{date}.pdf";
        ...
        public void GenerateCustomerInvoiceSummaryReportExcel(IEnumerable<CustomerInvoiceSummaryModel> reports, string path, string month, string reportType, DateTime start, DateTime end)
        {
            ...
            var filePath = $@"{directoryPath}\{month}-{date}.xlsx";
            bool showPaymentColumns = reportType != "only pending or overdue";

            using (ExcelPackage package = new ExcelPackage())
            {
                var worksheet = package.Workbook.Worksheets.Add("Customer Invoice Summary");
                ...
                worksheet.Cells[rowCounter, 1, rowCounter, 3].Style.Font.Bold = true;
                worksheet.Cells[rowCounter, 1, rowCounter, 3].Style.Fill.PatternType = ExcelFillStyle.Solid;
                worksheet.Cells[rowCounter, 1, rowCounter, 3].Style.Fill.BackgroundColor.SetColor(System.Drawing.Color.LightGray);
                worksheet.Cells[rowCounter, 1, rowCounter, 3].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;

                worksheet.Cells[rowCounter, 1, rowCounter, 3].Style.Border.Top.Style = ExcelBorderStyle.Thin;
                worksheet.Cells[rowCounter, 1, rowCounter, 3].Style.Border.Right.Style = ExcelBorderStyle.Thin;
                worksheet.Cells[rowCounter, 1, rowCounter, 3].Style.Border.Left.Style = ExcelBorderStyle.Thin;
                worksheet.Cells[rowCounter, 1, rowCounter, 3].Style.Border.Bottom.Style = ExcelBorderStyle.Thin;
                ...
                worksheet.Cells[rowCounter, 2, rowCounter, 3].Style.Border.Top.Style = ExcelBorderStyle.Thin;
                worksheet.Cells[rowCounter, 2, rowCounter, 3].Style.Border.Left.Style = ExcelBorderStyle.Thin;
                worksheet.Cells[rowCounter, 2, rowCounter, 3].Style.Border.Right.Style = ExcelBorderStyle.Thin;
                worksheet.Cells[rowCounter, 2, rowCounter, 3].Style.Border.Bottom.Style = ExcelBorderStyle.Thin;
