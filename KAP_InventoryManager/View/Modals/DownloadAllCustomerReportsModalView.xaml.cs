...
namespace KAP_InventoryManager.View.Modals
{
    ...
    {
        private ViewModel.ModalViewModels.DownloadAllCustomerReportsModalViewModel _viewModel;
        public DownloadAllCustomerReportsModalView()
        {
            InitializeComponent();
            _viewModel = new ViewModel.ModalViewModels.DownloadAllCustomerReportsModalViewModel();
